...
------------------------------------------------------------------------------------------------------------------
cat $ANDROID_NDK_PATH/toolchains/llvm/prebuilt/linux-x86_64/lib/clang/17/lib/linux/arm/libatomic.a
# copy over the .a file that contains the atomic definitions
